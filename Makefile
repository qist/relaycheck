...
# 目标列表
TARGETS := \
	$(OUT_DIR)/Relaycheck-linux-amd64 \
	$(OUT_DIR)/Relaycheck-linux-arm64 \
	$(OUT_DIR)/Relaycheck-linux-armv7 \
	$(OUT_DIR)/Relaycheck-linux-386 \
	$(OUT_DIR)/Relaycheck-linux-ppc64 \
	$(OUT_DIR)/Relaycheck-linux-ppc64le \
	$(OUT_DIR)/Relaycheck-linux-s390x \
	$(OUT_DIR)/Relaycheck-windows-amd64.exe \
	$(OUT_DIR)/Relaycheck-windows-arm64.exe \
	$(OUT_DIR)/Relaycheck-windows-386.exe \
	$(OUT_DIR)/Relaycheck-darwin-amd64 \
	$(OUT_DIR)/Relaycheck-darwin-arm64 \
	$(OUT_DIR)/Relaycheck-android-arm64 
